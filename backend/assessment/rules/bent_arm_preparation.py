"""Bent-Arm Preparation — bent elbow with bottle near wrist."""
...
@dataclass
class BentArmPreparationAssessor:
            ...
            if self.hold_frames >= HOLD_FRAMES_REQUIRED:
                self.checks = [
                    CheckResult(
                        ...
                        "Elbow bent in preparation range."
                        if bent
                        else "Bend your elbow into the preparation range.",
